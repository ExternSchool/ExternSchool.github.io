...
<br>
**Ключ подтверждения/Validation key** - используется для идентификации пользовательской учетной записи при установке постоянной
...
<img src="https://user-images.githubusercontent.com/10642971/41467437-344f5aea-70af-11e8-86e3-b0bd6d95424d.png" 
...
как Администратор, я могу генерировать ключи подтверждения (validation key), чтобы контролировать связь пользовательких
